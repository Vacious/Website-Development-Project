    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    <li>
                        <a href="dashboard-user.php" class="active"><span class="fas fa-house-user"></span>
                ...
                <div class="cards">
                    <div class="card-single">
                        <div>
                            ...
                            $query = "SELECT first_name FROM myuser WHERE no='$id'";
                            $rs = $conn->query($query);
                    ...
                    <div class="card-single">
                        <div>
                            ...
                            $query = "SELECT count(*) FROM transtb WHERE userID='$id'";
                            $rs = $conn->query($query);
                ...
                <div class="transaction">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="transaction-user.php"><button>See All</button></a>
                        </div>
                        ...
                        <div class="card-body">
                            <table>
                                ...
                                $query = "SELECT * FROM transtb WHERE userID='$id' ORDER BY date DESC LIMIT 2";
                                $rs = $conn->query($query);
