...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($flag){
        $s = "SELECT * FROM coursetb WHERE courseName = '$CourseName'";
        $result = mysqli_query($conn, $s);
        $num = mysqli_num_rows($result);
        if($num){
            $CourseName_error = "This course is already created.";
        } else{
            $sql = "INSERT INTO coursetb(courseImage, courseName, courseDesc, coursePrice) VALUES('images/logo.png', '$CourseName', '$CourseDesc', '$CoursePrice')";
            if(mysqli_query($conn, $sql)){
                echo '<script>alert("Create course successfully")</script>';
            }else{
                echo '<script>alert("Create course unsuccessfully")</script>';
            }
        }
    }
...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="content">
                <div class="container">
                    <div class="title" style="text-align: center;">Create Course</div>
